...
| **OLAP** (§2) | [duckdb](engines/duckdb.md) | [clickhouse](engines/clickhouse.md) · [starrocks](engines/starrocks.md) | [self-hosted lakehouse](concepts/lakehouse.md) · [apache-druid](engines/apache-druid.md) · [greenplum](engines/greenplum.md) · [trino](engines/trino.md) | [snowflake](engines/snowflake.md) · [cloud lakehouse](concepts/lakehouse.md) · [google-bigquery](engines/google-bigquery.md) · [MotherDuck](https://motherduck.com/) |
| **Document** (§3) | [realm](engines/realm.md) · [pouchdb](engines/pouchdb.md) | [mongodb](engines/mongodb.md) · [couchdb](engines/couchdb.md) | [mongodb](engines/mongodb.md) (sharded) · [couchbase](engines/couchbase.md) | [mongodb-atlas](https://www.mongodb.com/lp/cloud/atlas/try4-reg) [google-cloud-firestore](engines/google-cloud-firestore.md) · [microsoft-azure-cosmos-db](engines/microsoft-azure-cosmos-db.md) |
